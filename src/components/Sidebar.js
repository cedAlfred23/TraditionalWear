...
const Sidebar = () => {
  ...
  <div className={`${isOpen ? 'right-0' : '-right-full'} 'w-full bg-white fixed top-0 h-full shadow-2xl md:w-[35vw] xl:max-w-[30wvw] transition-all duration-300 z-20 px-4 lg:px-[35px]'`}>
    ...
    <div className='flex flex-col gap-y-2 h-[400px] lg:h-[500px] xl:h-[700px] overflow-y-auto overflow-x-hidden border-b mb-20'>
      {cart.map((item) => {
